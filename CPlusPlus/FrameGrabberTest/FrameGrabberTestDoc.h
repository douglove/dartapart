...
public:
	...
	bool        m_CalibrateScanLine;
	bool        m_CalibrateBackground;
	bool        m_bClearWatch;
	int         m_iBackgroundCount;
	int         m_iScanLine;
	int         m_iPrevDartsFound;
	float       m_dartLocations[3];
	int         m_scanLineY[640];
	int         m_backgroundLine[640];
	int         m_iDefaultScanLine;
	int         m_iThreshold;
	int         m_iThresholdBG;
	DartDataServer * m_pDataServer;
// Operations
public:
